...
def resumo(total, aum=10, dim=5):
    print(f'-' * 30)
    print(f'{"RESUMO DO VALOR":^30}') # ou 'RESUMO DO VALOR'.center(30)
    print(f'-' * 30)
...
# Obs: t\ de "tabulação". Se a informação não ficar tabulada, podemos adicionar outro \t, ficando \t\t antes da
# Informação que deseja tabular.